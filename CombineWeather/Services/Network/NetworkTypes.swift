...
protocol Endpointable {
    ...
    var appendTokenToParams: Bool { get }
    var body: Data? { get }
...
extension Endpointable {
    ...
    var urlRequest: URLRequest {
        ...
        if appendTokenToParams {
            queryParams["appid"] = Secrets.API_KEY
        }

        if !queryParams.isEmpty, var components = URLComponents(url: url, resolvingAgainstBaseURL: false) {
